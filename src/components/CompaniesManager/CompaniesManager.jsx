  ...
  return (
    <div className={styles.listWrapper} dir="rtl">
      ...
      <div className={styles.verticalStack}>
        {loading && (
          <CloudLoader message="loading" customClass={styles.companyLoader} />
        )}

        {!loading && (
          <div className={styles.verticalStack}>
            {companies.map(company => {
              const statusObj = getSubscriptionStatus(company.subscription_expiry);
              return (
                  ...
                  <div className={styles.cardBody}>
                    ...
                    <div className={styles.subInfo}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '5px', marginBottom: '12px' }}>
                        <span style={{ color: '#00f2fe', fontWeight: 'bold' }}>👤 مشترك : {company.owner_name || '---'}</span>
                      ...
                      {/* صندوق بيانات الاشتراك مع حالة ملونة */}
                      <div style={{
                        ...
                        <div style={{ gridColumn: 'span 2', borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: '8px', marginTop: '5px' }}>
                          <small style={{ color: '#718096' }}>حالة الاشتراك: </small>
                          <span style={{ background: statusObj.bg, color: statusObj.color, padding: '4px 8px', borderRadius: '12px', fontSize: '12px', marginRight: '8px' }}>
                            {statusObj.text}
                          </span>
                        </div>
